                    ...
                    <Grid container direction='column'>
                      ...
                      <Grid item xs={12}>
                        ...
                        <Typography
                          ...
                          className={classes.value}
                        >
                          We believe that technology is only as good as the
                          people and intentions behind it. We want EOS to be
                          decentralized, promote freedom, cut, inefficiencies in
                          government, help sustainable development, secure
                          censorship-resistance, increase individual sovereignty
                          and advance citizen advocacy Each of the projects we
                          promote must provide a “Proof of impact” in the
...
export default withStyles(style)(
  withNamespaces('bpProfilePage')(BlockProducerProfile)
)
