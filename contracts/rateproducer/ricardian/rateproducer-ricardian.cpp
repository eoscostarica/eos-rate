...
// CONTRACTS
const char* eoscostarica::rate_ricardian = R"(
spec-version: 0.1.0
...
const char* eoscostarica::erase_ricardian = R"(
spec-version: 0.1.0
...
const char* eoscostarica::wipe_ricardian = R"(
spec-version: 0.1.0
...
const char* eoscostarica::rminactive_ricardian = R"(
spec-version: 0.1.0
...
const char* eoscostarica::rmrate_ricardian = R"(
spec-version: 0.1.0
...
// CLAUSES
const char* eoscostarica::datastorage_clause = R"(
spec-version: 0.1.0
...
const char* eoscostarica::datausage_clause = R"(
spec-version: 0.1.0
...
const char* eoscostarica::dataownership_clause = R"(
spec-version: 0.1.0
...
const char* eoscostarica::datadistribution_clause = R"(
spec-version: 0.1.0
...
const char* eoscostarica::datafuture_clause = R"(
spec-version: 0.1.0
title: Data Future
